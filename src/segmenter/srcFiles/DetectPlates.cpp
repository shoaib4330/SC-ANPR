...
#include "../headers/DetectPlates.h"
...
std::vector<PossiblePlate> detectPlatesInScene(cv::Mat &imgOriginalScene) {
    ...
    preprocess(imgOriginalScene, imgGrayscaleScene, imgThreshScene);        // preprocess to get grayscale and threshold images_for_segmentation_tesing
