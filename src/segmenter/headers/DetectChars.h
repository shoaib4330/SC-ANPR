...
const int MIN_PIXEL_WIDTH = 19;//2
const int MIN_PIXEL_HEIGHT = 35;//8

const int MAX_PIXEL_WIDTH = 55;//2
const int MAX_PIXEL_HEIGHT = 65;//8

const double MIN_ASPECT_RATIO = 0.45;//0.25
const double MAX_ASPECT_RATIO = 1;

const int MIN_PIXEL_AREA = 600;//80
const int MAX_PIXEL_AREA = 3575;
...
const int RESIZED_CHAR_IMAGE_WIDTH = 40;
const int RESIZED_CHAR_IMAGE_HEIGHT = 60;
